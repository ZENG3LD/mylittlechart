//! Screenshot capture, PNG encoding, and timestamp filename helpers.
...
pub(crate) fn timestamp_for_filename() -> String {
...
pub(crate) fn add_copy_src_to_target_texture(surface: &mut RenderSurface<'_>, device: &wgpu::Device) {
...
pub(crate) fn screenshot_save_dir() -> std::path::PathBuf {
...
pub(crate) fn encode_png(pixels: &[u8], width: u32, height: u32) -> Option<Vec<u8>> {
