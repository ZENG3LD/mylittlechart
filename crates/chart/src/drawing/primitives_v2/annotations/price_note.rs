...
pub fn metadata() -> PrimitiveMetadata {
    PrimitiveMetadata {
        ...
        factory: |points, color| { let (t1, p1) = points.first().copied().unwrap_or((0, 0.0)); let (t2, p2) = points.get(1).copied().unwrap_or((t1+600_000, p1+10.0)); Box::new(PriceNote::new(t1, p1, t2, p2, color)) },
        supports_text: true,
        has_levels: false,
