...
//!
//! Thin wrapper around `uzor_render_vello_cpu::VelloCpuRenderContext` that
...
use uzor_render_vello_cpu::VelloCpuRenderContext as InnerContext;
...
///
/// All drawing primitives are delegated to [`uzor_render_vello_cpu::VelloCpuRenderContext`].
...
impl<'a> Painter for VelloCpuChartRenderContext<'a> {
...
impl<'a> TextRenderer for VelloCpuChartRenderContext<'a> {
...
impl<'a> TextMetrics for VelloCpuChartRenderContext<'a> {
...
impl<'a> Masking for VelloCpuChartRenderContext<'a> {
    fn clip(&mut self) { self.inner.clip() }
}

// ─── Effects ──────────────────────────────────────────────────────────────────

impl<'a> Effects for VelloCpuChartRenderContext<'a> {
...
impl<'a> ShapeHelpers for VelloCpuChartRenderContext<'a> {
...
impl<'a> BatchPainter for VelloCpuChartRenderContext<'a> {
...
impl<'a> GradientPainter for VelloCpuChartRenderContext<'a> {
...
// ─── UiEffectHelpers — default impls (no blur in vello-cpu backend) ───────────

impl<'a> UiEffectHelpers for VelloCpuChartRenderContext<'a> {}
...
// ─── RenderContextExt — vello-cpu backend has no blur image ──────────────────
